...
<html>
<head>
<base href="http://www.biaobaishike.com/quwei_zaixianbofang/" />
    <meta charset="utf-8">
    ...
    <meta name="keywords" content="在线播放器,在线音乐播放器,xiaobin,网易云音乐,音乐api,音乐播放器源代码"/>
...
<div class="center">
    <div class="container">
        ...
        <div class="player" id="player">
            <!--歌曲封面-->
            <div class="cover">
                <img src="picture/player_cover.png" class="music-cover" id="music-cover">
            </div>
            <!--滚动歌词-->
            <div class="lyric">
                <ul id="lyric"></ul>
